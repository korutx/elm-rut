...
var author$project$Rut$Cleared = {$: 'Cleared'};
var author$project$Rut$Simple = {$: 'Simple'};
var author$project$Rut$ThousandsSeparated = {$: 'ThousandsSeparated'};
...
var author$project$Rut$computeDv = function (rut) {
	var _n0 = A3(
		elm$core$List$foldr,
		F2(
			function (d, _n1) {
				var suma = _n1.a;
				var mul = _n1.b;
				var num = elm$core$Char$toCode(d) - 48;
				var mul1 = A2(elm$core$Basics$modBy, 8, mul + 1);
				var mul2 = (mul1 > 0) ? mul1 : 2;
				return _Utils_Tuple2(suma + (num * mul), mul2);
			}),
		_Utils_Tuple2(0, 2),
		elm$core$String$toList(rut));
	var s = _n0.a;
	var m = _n0.b;
	var _n2 = A2(elm$core$Basics$modBy, 11, s);
	switch (_n2) {
		case 1:
			return 'k';
		case 0:
		...
		default:
			return elm$core$String$fromInt(
				11 - A2(elm$core$Basics$modBy, 11, s));
	}
};
var author$project$Rut$justStr = function (maybeStr) {
	if (maybeStr.$ === 'Nothing') {
		return '';
	} else {
		var str = maybeStr.a;
...
var author$project$Rut$replace = F3(
	function (regexStr, replacer, str) {
		var _n0 = elm$regex$Regex$fromString(regexStr);
		if (_n0.$ === 'Nothing') {
			return str;
		} else {
			var regex = _n0.a;
...
var author$project$Rut$clearFormat = function (str) {
	return A3(
		author$project$Rut$replace,
		'[\\.\\-]',
		function (_n0) {
			return '';
		},
...
var author$project$Rut$splitRutAndDv = function (str) {
	var clearedStr = author$project$Rut$clearFormat(str);
	var _n0 = elm$core$String$length(clearedStr);
	switch (_n0) {
		case 0:
			return {dv: elm$core$Maybe$Nothing, rut: elm$core$Maybe$Nothing};
		case 1:
			return {
				dv: elm$core$Maybe$Nothing,
				rut: elm$core$Maybe$Just(clearedStr)
			};
		default:
			return {
				dv: elm$core$Maybe$Just(
					A2(elm$core$String$right, 1, clearedStr)),
				rut: elm$core$Maybe$Just(
					A3(elm$core$String$slice, 0, -1, clearedStr))
			};
	}
};
...
var author$project$Rut$thousandsFormatter = F2(
	function (_char, text) {
		return ((elm$core$String$length(text) > 0) && (!A2(
			elm$core$Basics$modBy,
			3,
			elm$core$String$length(
				author$project$Rut$clearFormat(text))))) ? (elm$core$String$fromChar(_char) + ('.' + text)) : _Utils_ap(
			elm$core$String$fromChar(_char),
			text);
	});
var author$project$Rut$thousandsFormat = A2(elm$core$String$foldr, author$project$Rut$thousandsFormatter, '');
var elm$core$Basics$neq = _Utils_notEqual;
var author$project$Rut$format = F2(
	function (formatter, value) {
		var rutdv = author$project$Rut$splitRutAndDv(value);
		if (_Utils_eq(rutdv.rut, elm$core$Maybe$Nothing)) {
			return elm$core$Maybe$Just(value);
		} else {
			if ((!_Utils_eq(rutdv.rut, elm$core$Maybe$Nothing)) && _Utils_eq(rutdv.dv, elm$core$Maybe$Nothing)) {
				return rutdv.rut;
			} else {
				switch (formatter.$) {
					case 'ThousandsSeparated':
						return elm$core$Maybe$Just(
							author$project$Rut$thousandsFormat(
								author$project$Rut$justStr(rutdv.rut)) + ('-' + author$project$Rut$justStr(rutdv.dv)));
					case 'Simple':
						return elm$core$Maybe$Just(
							author$project$Rut$justStr(rutdv.rut) + ('-' + author$project$Rut$justStr(rutdv.dv)));
					default:
						return elm$core$Maybe$Just(
							_Utils_ap(
								author$project$Rut$justStr(rutdv.rut),
								author$project$Rut$justStr(rutdv.dv)));
				}
			}
		}
	});
var author$project$Rut$isValidRut = F2(
	function (minimumLength, rut) {
		var crut = author$project$Rut$clearFormat(rut);
		if (_Utils_cmp(
			elm$core$String$length(crut),
			minimumLength) < 0) {
			return false;
		} else {
			var rutdv = author$project$Rut$splitRutAndDv(rut);
			return _Utils_eq(
				author$project$Rut$computeDv(
					author$project$Rut$justStr(rutdv.rut)),
				author$project$Rut$justStr(rutdv.dv));
		}
	});
...
var author$project$RutTest$suite = A2(
	...
	_List_fromArray(
		[
			...
			'Cleared format',
			function (_n0) {
				var rutList = _List_fromArray(
					['111111111', '11.111.111-1', '11111111-1', '', '1', 'K', '1-1']);
				var cleared = _List_fromArray(
					['111111111', '111111111', '111111111', '', '1', 'K', '11']);
				var justCleared = A2(
					elm$core$List$map,
					function (c) {
				...
				return A2(
					...
					A2(
						elm$core$List$map,
						function (rut) {
							return A2(author$project$Rut$format, author$project$Rut$Cleared, rut);
						},
						rutList));
			}),
			A2(
			...
			function (_n1) {
				var rutList = _List_fromArray(
					['111111111', '11.111.111-1', '11111111-1', '', '1', 'K', '1-1']);
				var cleared = _List_fromArray(
					['11111111-1', '11111111-1', '11111111-1', '', '1', 'K', '1-1']);
				var justCleared = A2(
					elm$core$List$map,
					function (c) {
						return elm$core$Maybe$Just(c);
				...
				return A2(
					...
					A2(
						elm$core$List$map,
						function (rut) {
							return A2(author$project$Rut$format, author$project$Rut$Simple, rut);
						},
						rutList));
			}),
			A2(
			...
			function (_n2) {
				var rutList = _List_fromArray(
					['111111111', '11.111.111-1', '11111111-1', '', '1', 'K', '1-1']);
				var cleared = _List_fromArray(
					['11.111.111-1', '11.111.111-1', '11.111.111-1', '', '1', 'K', '1-1']);
				var justCleared = A2(
					elm$core$List$map,
					function (c) {
						return elm$core$Maybe$Just(c);
				...
				return A2(
					...
					A2(
						elm$core$List$map,
						function (rut) {
							return A2(author$project$Rut$format, author$project$Rut$ThousandsSeparated, rut);
						},
						rutList));
			}),
			A2(
			...
			function (_n3) {
				var rutList = _List_fromArray(
					['24952044', '11111111', '44444444', '33916942', '1773599', '7588158', '12432815', '15985120', '17566826', '19992589', '30027608', '32869435', '33344065', '39191587', '39872491']);
				var cleared = _List_fromArray(
					['6', '1', '4', 'k', '3', '4', '2', '6', '8', 'k', '3', '2', '2', '3', '7']);
				return A2(
					elm_explorations$test$Expect$equal,
					cleared,
					A2(
						elm$core$List$map,
						function (rut) {
							return author$project$Rut$computeDv(rut);
						},
						rutList));
			}),
			A2(
			...
			function (_n4) {
				var rutList = _List_fromArray(
					['24952044-6', '11111111-1', '44.444.444-4', '33.916.942-k', '1.773.599-0', '7588158-4', '12432815-2', '15985120-6', '17566826-8', '19992589-k', '30027608-3', '32869435-2', '33344065-2', '39191587-5', '39872491-7', '1-1']);
				var cleared = _List_fromArray(
					[true, true, true, true, false, true, true, true, true, true, true, true, true, false, true, false]);
				return A2(
					elm_explorations$test$Expect$equal,
					cleared,
					A2(
						elm$core$List$map,
						function (rut) {
							return A2(author$project$Rut$isValidRut, 6, rut);
						},
						rutList));
			})
		]));
...
var author$project$Test$Generated$Main3403747048$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/ec2-user/environment/elm-rut/tests/RutTest.elm']),
		processes: 2,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 159253045892634
	},
	elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'RutTest',
				_List_fromArray(
					[author$project$RutTest$suite]))
			])));
_Platform_export({'Test':{'Generated':{'Main3403747048':{'init':author$project$Test$Generated$Main3403747048$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-22273.sock";
